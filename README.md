...
- **桌面窗口引擎（v2.24.0）** — 从桌面/开始菜单启动**手机应用**时以电脑窗口形态运行：桌面级大尺寸、悬浮于桌面、任务栏可见。MIUI/HyperOS 优先走厂商专有自由窗口通道；内置"设置 → 桌面窗口"诊断中心（引擎状态 / 卡全屏修复 / 一键复制诊断报告），详见 [docs/DESKTOP_WINDOW.md](docs/DESKTOP_WINDOW.md)
