...
public abstract class Box86_64PresetManager {
    ...
    public static ArrayList<Box86_64Preset> getPresets(String prefix, Context context) {
        ...
        presets.add(new Box86_64Preset(Box86_64Preset.STABILITY, "Stability"));
        presets.add(new Box86_64Preset(Box86_64Preset.COMPATIBILITY, "Compatibility"));
        presets.add(new Box86_64Preset(Box86_64Preset.INTERMEDIATE, "Intermediate"));
        presets.add(new Box86_64Preset(Box86_64Preset.PERFORMANCE, "Performance"));
