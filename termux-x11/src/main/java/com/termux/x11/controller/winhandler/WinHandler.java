...
public class WinHandler {
    ...
    /**
     * AnWind（v2.22.3 fix10）：宿主解耦 —— 原先强绑定 MainActivity，
     * 导致 X11 桌面浮动窗口（com.anwind X11Surface）模式下虚拟手柄
...
//                activity.getXServerView().requestRender();
    ...
    /**
     * AnWind hotfix：本方法绝不能在主线程执行网络/DNS 操作。
    ...
    /** AnWind（v2.22.3 fix10）：统一取当前活跃的手柄配置（宿主可能未就绪）。 */
